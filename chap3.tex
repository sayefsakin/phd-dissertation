...
\begin{refsection}
This work is based on previously published work, \copyright  2022 IEEE, Reprinted with permission from S. A. Sakin, A. Bigelow, R. Tohid, C. Scully-Allison, C. Scheidegger, S. R. Brandt, C. Taylor, K. A. Huck, H. Kaiser, and K. E. Isaacs, ``Traveler: Navigating task parallel traces for performance analysis,'' IEEE Trans. on Vis. \& Comp. Graph., vol. 29, no. 1, pp. 788-797, 2022.
