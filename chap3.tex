...
\addfigure[width=0.9\columnwidth]{figs/agg_gantt_depp.png}{Aggregated Gantt (Left) view shows one bar by combining all subsequent events initiated from a single event. Dependency Tree View (Right) shows the node-link diagram generated from the dependencies among the events.}{fig:agg_depp}
