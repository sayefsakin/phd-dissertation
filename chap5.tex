...
\begin{refsection}
This work is based on previously published work, \copyright  2025 IEEE, Reprinted with permission from S. A. Sakin and K. E. Isaacs, ``Managing Data for Scalable and Interactive Event Sequence Visualization,'' in 2025 IEEE 15th Symp. on Large Data Analysis and Vis. (LDAV), IEEE, 2025, pp. 33-43.
...
\addfigure[width=0.9\columnwidth, alt={Comparison of average fetch time (top) and visual accuracy (bottom) across seven data management configurations for range queries. The dashed line marks the 100ms interactivity threshold. ESeMan configurations reduce average fetch time while preserving high visual accuracy.}]{figs/window_data_fetch_comparison.png}{Comparison of average fetch time (top) and visual accuracy (bottom) across seven data management configurations for range queries. The dashed line marks the 100ms interactivity threshold. ESeMan configurations reduce average fetch time while preserving high visual accuracy.}{fig:rangeqb}
...
\addfigure[width=0.9\columnwidth, alt={Comparison of avergage rendering time (top) and percent increase from the lowest rendering time (bottom) across seven data management configurations for range queries. ESeMan configurations outperform alternatives in rendering time.}]{figs/window_total_drawing_relative_increase.png}{Comparison of avergage rendering time (top) and percent increase from the lowest rendering time (bottom) across seven data management configurations for range queries. ESeMan configurations outperform alternatives in rendering time.}{fig:rangeqc}
...
\addfigure[width=0.9\columnwidth, alt={Comparison of average fetch time (top) and visual accuracy (bottom) across seven data management configurations for conditional range queries. The dashed line marks the 100ms interactivity threshold. ESeMan configurations reduce average fetch time while preserving high visual accuracy.}]{figs/cond_data_fetch_comparison.png}{Comparison of average fetch time (top) and visual accuracy (bottom) across seven data management configurations for conditional range queries. The dashed line marks the 100ms interactivity threshold. ESeMan configurations reduce average fetch time while preserving high visual accuracy.}{fig:crangeqb}
...
\addfigure[width=0.9\columnwidth, alt={Comparison of avergage rendering time (top) and percent increase from the lowest rendering time (bottom) across seven data management configurations for conditional range queries. ESeMan configurations outperform alternatives in rendering time.}]{figs/cond_total_drawing_relative_increase.png}{Comparison of avergage rendering time (top) and percent increase from the lowest rendering time (bottom) across seven data management configurations for conditional range queries. ESeMan configurations outperform alternatives in rendering time.}{fig:crangeqc}
...
\addfigure[width=\columnwidth, alt={Parallel timeline charts constructed from 160K events distributed across 49 processors (rows) of a parallel program. Gray boxes with dark borders represent single event. (a) shows a naive rendering of all data, (b - d) show renderings using ESeMan with varying summarization levels. The naive solution requires 499 milliseconds (ms) for the data fetch, which is outside best practices for interactivity. ESeMan retrieves data for an equivalent chart in one tenth the time and can be tuned to trade off accuracy for fetch time. In (c), a 16-pixel summarization window reduces fetch time by half with noticeable visual differences (quantified by the SSIM score). In (d), a 32-pixel window further decreases fetch time with further degradation to accuracy.}]{figs/esemanteaser.png}{Parallel timeline charts constructed from 160K events distributed across 49 processors (rows) of a parallel program. Gray boxes with dark borders represent single event. (a) shows a naive rendering of all data, (b - d) show renderings using ESeMan with varying summarization levels. The naive solution requires 499 milliseconds (ms) for the data fetch, which is outside best practices for interactivity. ESeMan retrieves data for an equivalent chart in one tenth the time and can be tuned to trade off accuracy for fetch time. In (c), a 16-pixel summarization window reduces fetch time by half with noticeable visual differences (quantified by the SSIM score). In (d), a 32-pixel window further decreases fetch time with further degradation to accuracy.}{fig:teasers}
