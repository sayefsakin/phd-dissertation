...
\begin{refsection}
This work is based on previously published work, 2024 IEEE, Reprinted with permission from S. A. Sakin and K. E. Isaacs, ``A literature-based visualization task taxonomy for gantt charts,'' in 2024 IEEE Vis. and Visual Analytics (VIS), IEEE, 2024, pp. 1-5.
